...
SyntaxTree::Or::Or(Base* v1, Base* v2) {
  this->v1 = v1;
  this->v2 = v2;
}

std::vector<Value> SyntaxTree::Or::toVMByteCode() {
  std::vector<Value> a = v2->toVMByteCode();
  for (Value i : v1->toVMByteCode()) {
    a.push_back(i);
  }
...
SyntaxTree::Xor::Xor(Base* v1, Base* v2) {
  this->v1 = v1;
  this->v2 = v2;
}

std::vector<Value> SyntaxTree::Xor::toVMByteCode() {
  std::vector<Value> a = v2->toVMByteCode();
  for (Value i : v1->toVMByteCode()) {
    a.push_back(i);
  }
...
SyntaxTree::LeftShift::LeftShift(Base* v1, Base* v2) {
  this->v1 = v1;
  this->v2 = v2;
}

std::vector<Value> SyntaxTree::LeftShift::toVMByteCode() {
  std::vector<Value> a = v2->toVMByteCode();
  for (Value i : v1->toVMByteCode()) {
    a.push_back(i);
  }
...
SyntaxTree::RightShift::RightShift(Base* v1, Base* v2) {
  this->v1 = v1;
  this->v2 = v2;
}

std::vector<Value> SyntaxTree::RightShift::toVMByteCode() {
  std::vector<Value> a = v2->toVMByteCode();
  for (Value i : v1->toVMByteCode()) {
    a.push_back(i);
  }
